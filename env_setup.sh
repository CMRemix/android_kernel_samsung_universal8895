...
# G955F
if [ "$TARGET" = "G955F" ] ; then
	export KERNEL_CONFIG="exynos8895-dream2lte_eur_open_defconfig";
fi;

# G950F
if [ "$TARGET" = "G950F" ] ; then
	export KERNEL_CONFIG="exynos8895-dreamlte_eur_open_defconfig";
fi;
